...
/*	
    ...
    PreviouslyExecutedHook, PreviousPdpte, PreviousPde, - We need to record previously executed hooked pages, to keep track of processor context switch.
    This way we can automatically cover our traces for each hook.
*/
